...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Tahun Ajar</h1>
</div>
    ...
    <div class="card-body" style="background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); border-radius: 12px;">
        <form action="{{ route('tahun-ajar.update', $tahunAjar->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kode_tahun_ajar') is-invalid @enderror" id="kode_tahun_ajar" name="kode_tahun_ajar" value="{{ old('kode_tahun_ajar', $tahunAjar->kode_tahun_ajar) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_tahun_ajar') is-invalid @enderror" id="nama_tahun_ajar" name="nama_tahun_ajar" value="{{ old('nama_tahun_ajar', $tahunAjar->nama_tahun_ajar) }}">
